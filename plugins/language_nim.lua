...
local ident = "[a-zA-Z][a-zA-Z0-9_]*"
local expr_start_chars = "a-zA-Z0-9'\"%(%[%{%`"
local expr_start_set = '['..expr_start_chars..']'
...
local user_patterns = {
  ...
  { pattern = { "'", "'", '\\' },             type = "string" },
  -- function calls
  { pattern = ident.."%f[(]",                 type = "function" },
  -- identifiers
  { pattern = "[A-Z][a-zA-Z0-9_]*",           type = "keyword2" },
  { pattern = ident,                          type = "symbol" },
  { pattern = { '`', '`' },                   type = "symbol" },
  -- operators
